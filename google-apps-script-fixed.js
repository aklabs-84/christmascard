// ========================================
// Google Apps Script for Christmas Tree Card (CORS 문제 해결 버전)
// ========================================
...
// 5. 배포 > 새 배포 클릭
// 6. 유형 선택: 웹 앱
// 7. 설명: "Christmas Tree Card API"
// 8. 실행 권한: 나
// 9. 액세스 권한: 모든 사용자
// 10. 배포 클릭
// 11. 배포 URL을 복사하여 config.js의 SCRIPT_URL에 입력
//
// ⚠️ 중요: 기존 배포를 수정할 경우 "새 배포"가 아닌 "배포 관리"에서 수정해야 합니다!
...
function getCards(sheet) {
  ...
  if (data.length === 0 || data[0][0] !== 'ID') {
    if (data.length === 0) {
      sheet.appendRow(['ID', 'AuthorName', 'PasswordHash', 'OrnamentType',
